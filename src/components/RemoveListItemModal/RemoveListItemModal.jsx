...
import { DeleteModalBox, ButtonBox, DeleteModalTitle, DeleteModalDescription, TitleBox, ButtonPadding, ButtonMargin, CloseButton, BrSpan } from "./RemoveListItemModal.styled"
...
const RemoveListItemModal = (id) => {
    ...
    return <Modal onClose={toggleModal}>
                    <DeleteModalBox>
                        ...
                        <TitleBox>
                            <CloseButton onClick={onClickCloseBtn}><Icon width='15px' height='15px' name='close'/></CloseButton>
                            <DeleteModalTitle>Delete entry</DeleteModalTitle>
                            <DeleteModalDescription>Are you sure you want to <BrSpan/> delete the entry?</DeleteModalDescription>
                             
                        </TitleBox>
                        
                        <ButtonBox>
                            <Button buttonType="cancel" style={{boxShadow: "none"}} onClick={onClickCloseBtn}><ButtonPadding>Cancel</ButtonPadding></Button> 
