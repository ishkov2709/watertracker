...
import { TodayWaterListContainer, TodayWaterListHeader, TodayWaterListing, AddWaterButton } from "./TodayWaterList.styled"
const waterItems = [ {
...
const TodayWaterList = (  ) => {
    return <TodayWaterListContainer>
        ...
        <TodayWaterListing>
            {waterItems.map(waterItem => <li key={waterItem._id}><TodayWaterListItem waterInfo={waterItem} /></li>)}
            <AddWaterButton> <Icon name="plus" stroke={color.primary.blue } /> Add Water</AddWaterButton>
        </TodayWaterListing>
