...
import {
    ...
    MarksContainer, LeftMark, RightMark, Mark, AddWaterButton
...
const WaterRatioPanel = () => {
    ...
    return <WaterRatioPanelContainer >
        ...
        <AddWaterButton> <Icon name="add" stroke={color.primary.white } /> Add Water</AddWaterButton>
